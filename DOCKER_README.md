# TradeNeuron - Algorithmic Trading Platform

TradeNeuron is a production-ready algorithmic trading platform providing a unified API layer across 24+ Indian brokers. Seamlessly integrate with TradingView, Amibroker, Excel, Python, and AI agents.
...
```bash
# Windows
docker-run.bat start      # Start TradeNeuron
docker-run.bat stop       # Stop TradeNeuron
