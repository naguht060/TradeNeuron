...
export default function RemoteMcp() {
  ...
  const handleSaveSettings = async () => {
    ...
    try {
      ...
      showToast.success('Saved. Restart the TradeNeuron service to apply.', 'admin')
    } catch (err: unknown) {
      const msg =
            ...
            <div className="flex items-center justify-between flex-wrap gap-3">
              <div>
                ...
                <CardDescription>
                  ...
                  <code className="mx-1">.env</code>; the TradeNeuron service must be restarted before
                  they take effect.
                </CardDescription>
              </div>
          ...
          <CardContent className="space-y-5">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-xs text-muted-foreground">
                Same as your TradeNeuron dashboard URL. Required when MCP is enabled. Used as the JWT
