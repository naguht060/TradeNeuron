...
// Convert DD-MMM-YYYY (API-returned expiry) to DDMMMYY (TradeNeuron symbol format).
...
export default function StrategyBuilder() {
  ...
  // TradeNeuron-symbol → tick size map, built from the live option chain.
  ...
  // Expiries are normalised to the TradeNeuron DDMMMYY format at the source so that
  ...
  const saveEditedLeg = useCallback(
    (updated: StrategyLeg) => {
      // Normalise expiry to the TradeNeuron DDMMMYY format — the dropdown may
