"""
Email Utility Functions for TradeNeuron
...
def send_test_email(recipient_email, sender_name="TradeNeuron Admin"):
    """
    ...
    try:
        ...
        subject = "TradeNeuron - SMTP Test Successful"
                    ...
                    <tr>
                        <td style="padding: 0 40px 40px 40px; text-align: center;">
                            ...
                            <p style="margin: 16px 0 0 0; font-size: 12px; color: #3f3f46;">
                                Sent by <span style="color: #a1a1aa;">TradeNeuron</span>
                            </p>
                        </td>
                    </tr>
                </table>
...
Your TradeNeuron SMTP configuration is working correctly.
...
def send_password_reset_email(recipient_email, reset_link, user_name="User"):
    ...
    try:
        ...
        subject = "Reset your TradeNeuron password"
...
We received a request to reset your TradeNeuron password. Click the link below to set a new password:
