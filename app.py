...
if __name__ == "__main__":
    ...
    if not _is_reloader_parent:
        print("\033[93mStarting TradeNeuron...\033[0m", flush=True)
...
def create_app():
    ...
    if os.getenv("MCP_HTTP_ENABLED", "False").lower() == "true":
        ...
        # TradeNeuron session cookie. Flask-WTF's global CSRFProtect would
        ...
        # browser-driven from the TradeNeuron session and uses the
